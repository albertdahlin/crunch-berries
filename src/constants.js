...
export const GROUND_WALKABLE     = [true,  true,  false, true,  false, false];
export const GROUND_BUILDABLE    = [true,  false, false, false, true,  false];
export const GROUND_SPEED_MULT   = [1.0,   1.0,   1.0,   0.5,   1.0,   1.0];
export const GROUND_BLOCKS_SIGHT = [false, false, false, false, false, true];

export const GROUND_BG         = ['#1a2a1a', '#2a2218', '#0a1a3a', '#2a2a0a', '#0a2a0a', '#2a2a2a'];
export const GROUND_CHAR       = ['', '.', '~', ',', '\u2663', '\u25B2'];
export const GROUND_CHAR_COLOR = ['', '#3a3028', '#1a3a6a', '#4a4a1a', '#1a5a1a', '#888'];

export const GROUND_NAMES = ['Grass', 'Road', 'Water', 'Swamp', 'Forest', 'Mountain'];
export const GROUND_HELP  = [
  ...
  'Impassable, not buildable, blocks line of sight',
];
